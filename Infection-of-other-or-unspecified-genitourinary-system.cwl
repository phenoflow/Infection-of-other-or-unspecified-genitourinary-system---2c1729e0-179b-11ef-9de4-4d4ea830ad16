...
steps:
  ...
  lower-infection-of-other-or-unspecified-genitourinary-system---secondary:
    run: lower-infection-of-other-or-unspecified-genitourinary-system---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  urogenital-infection-of-other-or-unspecified-genitourinary-system---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: lower-infection-of-other-or-unspecified-genitourinary-system---secondary/output
